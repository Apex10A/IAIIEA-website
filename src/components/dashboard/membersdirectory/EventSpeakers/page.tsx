  ...
  return (
    <div className='mx-14'>
      <div className='flex items-center justify-between'>
        <div>
          <h1 className='text-[28px] text-[#0B142F] font-[500] pb-1'>Registered Speakers</h1>
        </div>
        <div className='mt-3'>
          <button className='bg-[#203a87] font-semibold text-white px-5 py-3 rounded-[30px] text-[17px]'>Add Speakers</button>
        </div>
      </div>
